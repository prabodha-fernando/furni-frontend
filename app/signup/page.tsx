...
const images = ['/hero-bg2.jpg', '/hero-bg3.jpg', '/hero-bg1.jpg']
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#e8e8e3] flex items-center justify-center p-4 sm:p-8">
      ...
      <motion.div
        className="w-full max-w-6xl bg-white rounded-[2rem] shadow-xl overflow-hidden lg:grid lg:grid-cols-2 min-h-[750px] border border-white"
      ...
      >
        ...
        {/* Left Side — Form Area */}
        <motion.div
          className="flex flex-col justify-center py-12 px-8 sm:px-16 lg:px-20 bg-white"
        ...
        >
          <div className="relative w-full h-full rounded-[1.5rem] overflow-hidden shadow-inner bg-zinc-900">
            ...
            <motion.div
              className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-2xl text-white shadow-2xl z-10"
